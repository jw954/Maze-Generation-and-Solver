...
//STUDENT_TEST("Duplicate Negatives with odd number of negatives"){
//    Queue<int> a = {-3, 4, -5, 10, -15};
//    Queue<int> b = {-3, -3, 4, -5, -5, 10, -15, -15};
...
//STUDENT_TEST("Duplicate Negatives with even number of negatives"){
//    Queue<int> a = {3, -4, 5, -10, 15};
//    Queue<int> b = {3, -4, -4, 5, -10, -10, 15};
...
//STUDENT_TEST("Duplicate Negatives with first number of negtaive"){
//    Queue<int> a = {-3, 4};
//    Queue<int> b = {-3, -3, 4};
...
//STUDENT_TEST("Duplicate Negatives with last number of negtaive"){
//    Queue<int> a = {3, -4};
//    Queue<int> b = {3, -4};
...
//STUDENT_TEST("Duplicate Negatives with all negatives"){
//    Queue<int> a = {-3, -4, -5, -10, -15};
//    Queue<int> b = {-3, -3, -4, -4, -5, -5, -10, -10, -15, -15};
